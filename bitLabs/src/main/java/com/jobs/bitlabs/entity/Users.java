...
public class Users {
	...
	@JoinTable(name = "user_job_applications", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "job_id"))
	...
	public Users(Long id, String name, String email, String whatsapp,
			@NotNull(message = "Qualification is required.") Qualifaction qualification, String specialization,
